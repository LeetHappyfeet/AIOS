...
async def resolve_claim_context(
    ...
    *,
    ...
    if not frame:
        ...
        # Retraction is intentionally deferred to project_character_knowledge.
        # Keeping resolver writes confined to resolver-owned tables prevents
        # cross-stage lock cycles with acquisition/materialization workers.
        return context
