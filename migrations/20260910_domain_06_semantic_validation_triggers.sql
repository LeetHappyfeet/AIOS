-- Recursive invalidation and evidence-change triggers for semantic validation.
-- Kept separate from the immutable decision-graph migration so applied
-- migration checksums remain stable.
