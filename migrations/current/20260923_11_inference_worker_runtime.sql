-- Complete the resilient inference worker runtime schema.
-- The runtime code landed with these fields, but its original migration lived
-- outside migrations/current and was therefore never executed by migrate.py.
